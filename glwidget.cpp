    ...
    QGLWidget(parent)
{
    ...
    //cria todas as variaveis necessarisas para o funcionamento do canvas e da apresentação do objeto 3D
        vertices = NULL;
        normals = NULL;
        texCoords = NULL;
        tangents = NULL;
...
//metodo que permiti o printar a tela e salva-la como uma arquivo .png
 void GLWidget::takeScreenshot(){

    QImage screenshot = grabFrameBuffer();
    QString fileName;
    fileName = QFileDialog::getSaveFileName(this ,
    "Save File As", QDir:: homePath(),
...
//inicia o canvas com as texturas e shaders aplicados
...
//altera o tamanho da tela inicial
...
//Troca a cor do background do widget que criamos para preto ou branco
...
//abre o chooser que permite escolher o arquivo .off que vai ser apresntado no canvas
...
//interpreta o  arquivo .off que vai ser apresntado no canvas
...
//a
    ...
    std::string line;
//verifica o numero de face e vetices encontrados no objeto .off selecionado
    stream >> line;
...
//cria os shaders que vão ser aplaicados no objeto 3D
...
//movementos basico do mouve que vao ser usado no trackball
...
// verifica a rotação da roda do mouse para aplicação de zoom
