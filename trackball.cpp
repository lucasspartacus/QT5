...
//verifica a mocimentação do mouse no canvas
...
//verifica se o mouse ets pressionado e a moveimentação que está apresentando ao obejt9o
...
//Verifica rotação apricada ao objeto gerada pelo mouse
